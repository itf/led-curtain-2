...
_pulsatingCircle = Pattern.pattern('_pulsatingCircle')(arg('cRadius=abs(frame%20-10)/30.')(circle))

_explosionRed = Pattern.pattern('_explosionRed')(arg('cRadius = sin(frame/30.)*2/3.; hue=0.05')(mask(circle,hueShift(trivial),meanP(red,trivial))))
